<script lang="ts">
	...
	async function selectSkillByName(name: string) {
		...
		try {
			...
			formPrompt = selectedSkill.prompt;
		} catch (e) {
	...
	<header class="page-header">
		<div class="header-content">
			<div>
				...
				<p class="subtitle">Manage skills in .claude/skills/</p>
			</div>
					...
					<form class="skill-form" on:submit|preventDefault={handleSave}>
						<div class="form-group">
							...
							<input
								...
								disabled={!isCreating}
							/>
							<span class="form-hint">Skill will be saved as .claude/skills/{formName || 'name'}.yaml</span>
						</div>
