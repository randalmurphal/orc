 ...
 * Timeline and Stats links are removed from primary navigation;
...
describe('TopBar navigation tabs (SC-5)', () => {
	...
	it('should render Knowledge navigation tab', () => {
		renderWithRouter(<TopBar />);

		const knowledgeLink = screen.getByRole('link', { name: /knowledge/i });
