...
func (s *Server) registerRoutes() {
	...
	s.mux.HandleFunc("GET /api/plugins/marketplace", cors(s.handleBrowseMarketplace))
	s.mux.HandleFunc("GET /api/plugins/marketplace/search", cors(s.handleSearchMarketplace))
	s.mux.HandleFunc("GET /api/plugins/marketplace/{name}", cors(s.handleGetMarketplacePlugin))
	s.mux.HandleFunc("POST /api/plugins/marketplace/{name}/install", cors(s.handleInstallPlugin))
