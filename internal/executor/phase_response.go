...
//
// NOTE: This function only does direct JSON parsing. For session-based output that
// may contain mixed text+JSON, use ExtractPhaseResponse which falls back to LLM extraction.
